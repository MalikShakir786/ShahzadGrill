...
class MyApp extends StatefulWidget {
  ...
  @override
  State<MyApp> createState() => _home_screenState();
}

class _home_screenState extends State<MyApp> {
  Uri dialNumber1 = Uri(scheme: 'tel', path: '');
  List imageList = [
    {'id': 1, 'image_path': 'lib/images/fast_food.jpg'},
    {'id': 2, 'image_path': 'lib/images/deliveryboy2.jpg'},
    {'id': 3, 'image_path': 'lib/images/chicken_tika.jpg'},
    {'id': 4, 'image_path': 'lib/images/fast_food.jpg'},
    {'id': 5, 'image_path': 'lib/images/mutton.jpg'},
    {'id': 1, 'image_path': 'lib/images/friends_meal.jpeg'},
  ];
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Center(
            child: Text(
              'About_Us',
              style: TextStyle(backgroundColor: HexColor(' #AA4203')),
            ),
          ),
        ),
        body: SafeArea(
